...
public class UserLoginController {
    ...
    public @ResponseBody UserLogin userRegister(@RequestBody UserLogin userLogin,
    ...
    public @ResponseBody UserLogin userEdit(@RequestBody UserLogin userLogin,
                                            Model model, HttpServletRequest request){
        if(userLogin.getLastName() != null || !"".equalsIgnoreCase(userLogin.getLastName())
                || userLogin.getFirstName() != null || !"".equalsIgnoreCase(userLogin.getFirstName())){
            userLogin.setUserName(userLogin.getLastName()+userLogin.getFirstName());
        }
    ...
    public @ResponseBody Object resetPwd(@RequestBody UserLogin userLogin,
                                            Model model, HttpServletRequest request){
        if(userLogin.getCurrentPassword() != null || !"".equalsIgnoreCase(userLogin.getCurrentPassword())){
            userLogin.setCurrentPassword(EncryptUtil.encryptSHA256(userLogin.getCurrentPassword()));
        }
    ...
    public @ResponseBody Object userDel(@PathVariable("userId") String userId,
                                           Model model, HttpServletRequest request){
        //1 假删除
