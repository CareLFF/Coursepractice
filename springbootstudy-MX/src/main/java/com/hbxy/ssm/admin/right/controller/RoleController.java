...
public class RoleController {
    ...
    public @ResponseBody Object roleGet(Model model, HttpServletRequest request){
    ...
    public @ResponseBody Object roleAdd(@RequestBody Role role,
    ...
    public @ResponseBody Object roleEdit(@RequestBody Role role,
                                        Model model, HttpServletRequest request){
        role.setCurrentStatus("0");//0-正常状态;1-删除状态;
        role.setLastUpdatedTime(new Timestamp(System.currentTimeMillis()));
        role.setLastUpdatedUserLoginId(UserLoginUtil.getUserLogin(request).getUserLoginId());
    ...
    public @ResponseBody Object roleEdit(@PathVariable String id,
                                         Model model, HttpServletRequest request){
    ...
    public @ResponseBody Object modules(Model model, HttpServletRequest request){
    ...
    public @ResponseBody Object roleRight(@PathVariable("roleId") String roleId, @RequestBody List<RightNode> rightNodes,
                                         Model model, HttpServletRequest request){
    ...
    public @ResponseBody Object roleRightList(@PathVariable("roleId") String roleId,
                                              Model model, HttpServletRequest request) {
        RoleRightExample example = new RoleRightExample();
        RoleRightExample.Criteria criteria = example.createCriteria();
        criteria.andRoleIdEqualTo(roleId);
