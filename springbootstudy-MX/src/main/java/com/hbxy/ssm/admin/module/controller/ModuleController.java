...
public class ModuleController {
    ...
    public @ResponseBody Object moduleAdd(@RequestBody Module module,
    ...
    public @ResponseBody Object moduleEdit(@RequestBody Module module,
                                        Model model, HttpServletRequest request){
        module.setCurrentStatus("0");//0-正常状态;1-删除状态;
        module.setLastUpdatedTime(new Timestamp(System.currentTimeMillis()));
        module.setLastUpdatedUserLoginId(UserLoginUtil.getUserLogin(request).getUserLoginId());
    ...
    public @ResponseBody Object moduleDelete(@PathVariable String id,
                                        Model model, HttpServletRequest request){
