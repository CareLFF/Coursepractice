...
public class PersonController {
    ...
    public @ResponseBody Person personAdd(@RequestBody Person person,
                                                Model model, HttpServletRequest request){
        //员工信息
    ...
    public @ResponseBody Person personEdit(@RequestBody Person person,
                                            Model model, HttpServletRequest request){
    ...
    public @ResponseBody Object personDelete(@PathVariable("id") String id,
                                           Model model, HttpServletRequest request){
        //1 假删除
